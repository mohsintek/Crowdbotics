<template>
  <div class="dashboard">
    <div class="dashboard-content">
      <img
        src="https://delgnnnzzjz4p.cloudfront.net/20210827.1/img/cb-login-logo.png"
        width="200"
      />
      <p>crowdboticsdashboard</p>
      <p>Build Application. Fast.</p>
      <p>
        Crowdbotics is the easiest way to build software applications, trusted
        by hundreds of teams. Sign up to start building your application.
      </p>
    </div>
    <div class="log_in">
      <div class="create-account">
        ...
        <b-form-group class="label" label="Email" label-for="input-formatter">
          <b-form-input
            type="email"
            id="input-formatter"
            v-model="user.email"
        ...
        <b-form-group label="Password" label-for="input-lazy1" class="mb-0">
          <b-form-input
            type="password"
            required
      ...
      <p>
        Dont have an account?<router-link to="/signup">Register</router-link>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handlesubmit() {
      this.login({ vm: this, payload: this.user });
